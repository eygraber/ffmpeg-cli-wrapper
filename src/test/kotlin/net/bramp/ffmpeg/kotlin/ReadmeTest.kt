...
import net.bramp.ffmpeg.kotlin.progress.Progress
...
class ReadmeTest @Throws(IOException::class) constructor() {
  ...
  fun testGetMediaInformation() {
    ...
    line1 shouldBe
      "File: 'src/test/resources/net/bramp/ffmpeg/kotlin/samples/big_buck_bunny_720p_1mb.mp4' ; Format: 'QuickTime / MOV' ; Duration: 5.312s"
