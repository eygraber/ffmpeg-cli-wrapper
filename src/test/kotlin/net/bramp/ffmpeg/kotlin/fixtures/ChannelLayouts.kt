...
import net.bramp.ffmpeg.kotlin.info.IndividualChannel
import net.bramp.ffmpeg.kotlin.info.StandardChannelLayout
...
val channelLayouts: List<ChannelLayout> = listOf(
  FL,
  FR,
  FC,
  LFE,
